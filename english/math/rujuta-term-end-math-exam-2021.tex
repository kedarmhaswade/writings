...
% prevent the footnote from breaking across pages
\interfootnotelinepenalty=10000

% math font sizes
\DeclareMathSizes{11}{16}{14}{12}
...
\Prob{
    ...
    It is said that we can express \emph{any} non unit fraction as a \textbf{sum of unit fractions} whose denominators are different. For example\footnote{Rujuta found a typo here. An earlier version of this exam paper that was carefully proofread said $\dfrac{5}{8}=\dfrac{1}{4}+\dfrac{1}{8}$.}, 

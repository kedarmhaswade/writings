...
we see that to produce 1 mol \ce{H2(g)} we need 2\si{\mol} \ce{HCl(aq)} and 1\si{\mol} \ce{Zn(s)}.
...
\let\thefootnote\relax\footnotetext{Author wishes to thank Apoorv Mhaswade for verifying the correctness of the calculations.}
\end{document}

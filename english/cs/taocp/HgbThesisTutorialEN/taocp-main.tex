...
%%% additional packages, use sparingly
\usepackage{amsthm}
...
\include{chapters/03-mmix-v1-fascicle1}
\include{chapters/04-arithmetic}
\include{chapters/05-sorting}
\include{chapters/06-searching}
\include{chapters/07-combinatorial-searching}
%\include{chapters/latex}
...
\include{back/appendix_0} % Technical supplements

...
Let's denote it by:$\;\textfractionsolidus\;$.
...
\end{reflection}
            \begin{equation}
                ...
                \begin{aligned}
                    ...
                    h_3(x_1,x_2,x_3)&=??\\
                    &\text{And,}\\
                    x_1\;\textfractionsolidus\;0=g(x_1)\\
                    x_1\;\textfractionsolidus\;(x_2+1)&=h_3(x_1,x_2,x_1\;\textfractionsolidus\;x_2)
                \end{aligned}
            \end{equation}
\begin{reflection}
...
\end{reflection}
    ...
    \begin{equation}
      ...
      x_1\;\textfractionsolidus\;x_2=
        \begin{cases}
            \texttt{NaN}, & \text{if $x_2=0$,}\\
            0, & \text{else if $x_1<x_2$,}\\
            1 + (x_1-x_2)\;\textfractionsolidus\;x_2&\text{otherwise}
		 \end{cases}
    \end{equation}
...
We assume a function, $\text{sq}$, which squares its argument.
    \begin{equation}

...
\author{केपी}
\date{पुणे, ८ ऑगस्ट २०२५\footnote{\begin{english}Updated from time to time.\end{english}}}
%\date{}
\maketitle
\vspace{5mm}
\hrule
...
ही उत्तरावली प्रथम ८ ऑगस्ट २०२५ ला लिहिलेली असली तरी वेळोवेळी संपादली (अद्ययावत केली) आहे; तश्या तारखांच्या नोंदी केल्या आहेत.
...
Here are \sout{5}6, choose any 3.
\begin{enumerate}
...
\item Die like a hedonist, before the infirmity of the old age defeats me: Live fast, die young, and leave a good-looking corpse behind.
  \item (A more probable one) Visit Vietnam\footnote{June 2026.}.
\end{enumerate}
...
\item Martin Gardner.
\item Ronald Read\footnote{Update on 16 December 2025. I had read about Ronald in Morgan Housel's \textit{The Psychology of Money} years ago, but forgot that he was one of my role models.} (the not-so-famous \href{https://en.wikipedia.org/wiki/Ronald_Read_(philanthropist)}{janitor philanthropist} who donated millions of dollars).
...
\item Alexander Grothendieck. It will be more appropriate to say I am curious about his life; he's not a \enquote*{role model}. He can't be (update in June 2026), but he is like no other!
...
\item I am also intrigued by the lives of many great, freethinking yet unknown authors, mathematicians, scientists, artists, athletes, open-source computer programmers (many of whom are women).
\end{enumerate}
...
\begin{enumerate}
    \item I used to like Madhuri Dixit when we were (both ;-)) younger. They used to call me MKD (Madhuri Ka Deewaanaa) in IIT Madras. I am not sure I'll like her now (haven't watched\footnote{Actually, I saw a recent picture of her in June 2026 that Hrishikesh shared; although I envied Hrishikesh (they both went to a wedding of a common acquaintance!) momentarily, I quickly got over the feeling ;-)} her recently); age catches up with everyone.
\item I grew up with Amitabh Bacchan and his aura of a \enquote*{hero} hasn't left me yet. My kids like him as a mellow old man (as opposed to how a whole generation knew him, an angry young man) in movies like \begin{marathi}बदला\end{marathi}.
\end{enumerate}
...
Update on 13 November 2025. The following quote (emphasis mine) has recently become one of my favorite quotes:

\begin{english}
\begin{displayquote}
I have striven not to laugh at human actions, not to weep at them, nor hate them, but to \textit{understand} them.
\end{displayquote}
\attrib{\textit{Baruch Spinoza}, TTP}
\end{english}

And these are slowly becoming my favorite:

\begin{english}
  \begin{displayquote}
    L'homme n'est rien, l'œuvre cest tout. (Man is nothing, (his) work is everything\footnote{June 2026. After becoming increasingly aware of my own fallibility and that of others!}.)
\end{displayquote}
\attrib{\textit{Gustave Flaubert}}
  \begin{displayquote}
    Man is condemned to be free.\footnote{May 2026. Jean-Paul Sartre's writings are compelling.}
\end{displayquote}
\attrib{\textit{Jean-Paul Sartre}}
  \begin{displayquote}
    Always tell the truth. You don't have to remember anything.
\end{displayquote}
\attrib{\textit{Mark Twain}}
...
\item\textbf{Any birthday resolution(s)?}\\
  ...
  (Update in June 2026) Always speak the truth\footnote{Sadly, this is sometimes difficult.}.

  (Update in June 2026) Renew the CPR certification. It saves lives.
